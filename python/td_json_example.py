...
#
# 2020.01.29 and/or later:
#
# Original from https://github.com/tdlib/td/blob/master/example/python/tdjson_example.py
#
# Modifications by https://github.com/nonlinear-chaos-order-etc-etal/
#
...
print('trying tdjson library: \'%s\'...' % tdjson_path)
