...
#include "tdjson_local.h"

#define TEST_DC_BOOL_STR "false"

void sendTdlibParameters(void *client) {
    td_json_client_send(client, "{\"@type\":\"setTdlibParameters\", \"@extra\":1, \"parameters\":{\"@type\":\"tdlibParameters\", \"use_test_dc\":" TEST_DC_BOOL_STR ", \"use_file_database\":true, \"use_chat_info_database\":true, \"use_message_database\":true, \"api_id\":" LOCAL_API_ID_STR ", \"api_hash\":\"" LOCAL_API_HASH_STR "\", \"system_language_code\":\"" LOCAL_LANG_CODE "\", \"device_model\":\"unknown\", \"system_version\":\"unknown\", \"application_version\":\"https://github.com/tdlib-rest/tdlib-rest/cpp-json-example/unknown-version\", \"ignore_file_names\":false, \"enable_storage_optimizer\":true}}");
}
